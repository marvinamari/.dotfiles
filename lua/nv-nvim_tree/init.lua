...
vim.g.nvim_tree_auto_ignore_ft = {} --{'startify', 'dashboard'} --"empty by default, don't auto open tree on specific fivimypes.
...
--vim.api.nvim_exec([[highlight NvimTreeFolderIcon guibg=blue]], true)
