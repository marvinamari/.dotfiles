...
_G.on_attach = function(server_name)
  ...
  vim.keymap.set("n", "<leader>dl", "<cmd>Telescope diagnostics<cr>", {buffer=0, desc= "LSP Telescope diagnostics"})
  ...
  -- Goto Preview
  vim.keymap.set('n', "gpd", "<cmd>lua require('goto-preview').goto_preview_definition()<CR>", {buffer=0, desc = "Definition - Goto preview "})
  vim.keymap.set('n', "gpt", "<cmd>lua require('goto-preview').goto_preview_type_definition()<CR>", {buffer=0, desc = "Type - Goto preview "})
  vim.keymap.set('n', "gpi", "<cmd>lua require('goto-preview').goto_preview_implementation()<CR>", {buffer=0, desc = "Implementation - Goto preview "})
  vim.keymap.set('n', "gpD", "<cmd>lua require('goto-preview').goto_preview_declaration()<CR>", {buffer=0, desc = "Declaration - Goto preview "})
  vim.keymap.set('n', "gpc", "<cmd>lua require('goto-preview').close_all_win()<CR>", {buffer=0, desc = "Close - Goto preview "})
  vim.keymap.set('n', "gpr", "<cmd>lua require('goto-preview').goto_preview_references()<CR>", {buffer=0, desc = "References - Goto preview "})
